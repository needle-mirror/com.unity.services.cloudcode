...
namespace Unity.Services.CloudCode.Authoring.Editor.Projects
{
    class CloudCodeProject
    {
        ...
        static readonly IDictionary<string, string> k_Dependencies = new Dictionary<string, string>
        {
            ...
            { "@unity-services/cloud-save-1.2", $"file:{InternalCloudSavePackage}-1.2.2.tgz" },
            ...
            { "@unity-services/economy-2.2", $"file:{InternalEconomyPackage}-2.2.1.tgz" },
            { "@unity-services/economy-2.3", $"file:{InternalEconomyPackage}-2.3.2.tgz" },
            { "@unity-services/economy-2.4", $"file:{InternalEconomyPackage}-2.4.1.tgz" },
            ...
            { "@unity-services/remote-config-1.1", $"file:{InternalRemoteConfigPackage}-1.1.2.tgz" },
            { "@unity-services/vivox-0.1", $"file:{InternalVivoxPackage}-0.1.6.tgz" },
            { "@unity-services/lobby-1.0", $"file:{InternalLobbyPackage}-1.0.1.tgz" },
            { "@unity-services/lobby-1.1", $"file:{InternalLobbyPackage}-1.1.2.tgz" },
