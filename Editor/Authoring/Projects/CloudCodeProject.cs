...
namespace Unity.Services.CloudCode.Authoring.Editor.Projects
{
    class CloudCodeProject
    {
        ...
        static readonly IDictionary<string, string> k_Dependencies = new Dictionary<string, string>
        {
            ...
            { "@unity-services/cloud-save-1.1", $"file:{InternalCloudSavePackage}-1.1.0.tgz" },
            { "@unity-services/cloud-save-1.2", $"file:{InternalCloudSavePackage}-1.2.0.tgz" },
            { "@unity-services/cloud-save-1.2.1", $"file:{InternalCloudSavePackage}-1.2.1.tgz" },
            { "@unity-services/cloud-save-1.3", $"file:{InternalCloudSavePackage}-1.3.0.tgz" },
            { "@unity-services/cloud-save-1.4", $"file:{InternalCloudSavePackage}-1.4.0.tgz" },
            ...
            { "@unity-services/economy-2.2", $"file:{InternalEconomyPackage}-2.2.0.tgz" },
            { "@unity-services/economy-2.2.1", $"file:{InternalEconomyPackage}-2.2.1.tgz" },
            { "@unity-services/economy-2.3", $"file:{InternalEconomyPackage}-2.3.0.tgz" },
            { "@unity-services/economy-2.3.1", $"file:{InternalEconomyPackage}-2.3.1.tgz" },
            { "@unity-services/economy-2.3.2", $"file:{InternalEconomyPackage}-2.3.2.tgz" },
            { "@unity-services/economy-2.4", $"file:{InternalEconomyPackage}-2.4.0.tgz" },
            { "@unity-services/economy-2.4.1", $"file:{InternalEconomyPackage}-2.4.1.tgz" },
            ...
            { "@unity-services/lobby-1.1", $"file:{InternalLobbyPackage}-1.1.0.tgz" },
            { "@unity-services/lobby-1.1.1", $"file:{InternalLobbyPackage}-1.1.1.tgz" },
            { "@unity-services/lobby-1.1.2", $"file:{InternalLobbyPackage}-1.1.2.tgz" },
            { "@unity-services/lobby-1.2", $"file:{InternalLobbyPackage}-1.2.0.tgz" },
        };
