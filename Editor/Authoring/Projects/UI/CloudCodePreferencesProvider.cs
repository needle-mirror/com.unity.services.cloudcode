...
{
    class CloudCodePreferencesProvider : SettingsProvider
    {
        ...
        ICloudCodePreferences m_Preferences;
        ICloudCodePreferences Preferences => m_Preferences ??= CloudCodeAuthoringServices.Instance.GetService<ICloudCodePreferences>();
        ...
        internal CloudCodePreferencesProvider() : base("Preferences/Cloud Code", SettingsScope.User)
        {
        ...
        {
            return new CloudCodePreferencesProvider();
        }
        ...
        void DrawJsDevEnvironment()
        {
            ...
            var nodeJSPathValue = Preferences.NodeJsPath;
            var npmValue = Preferences.NpmPath;
            ...
            Preferences.NodeJsPath = nodeJSPathValue;
            Preferences.NpmPath = npmValue;
        ...
        void DrawExternalEditor()
        {
            ...
            {
                var externalEditorPathValue = Preferences.ExternalEditorPath;
                ...
                Preferences.ExternalEditorPath = externalEditorPathValue;
            }

            using (new EditorGUILayout.HorizontalScope())
            {
                var externalEditorArgsFormatValue = Preferences.ExternalEditorArgsFormat;
                ...
                Preferences.ExternalEditorArgsFormat = externalEditorArgsFormatValue;
            }
        ...
        void DrawApplyRevertButtons()
        {
            ...
            if (GUILayout.Button(k_Revert))
            {
                ...
                Preferences.LoadFromEditorPrefs();
                m_Dirty = false;
            }

            if (GUILayout.Button(k_Apply))
            {
                Preferences.WriteToEditorPrefs();
                m_Dirty = false;
            }
            GUI.enabled = true;
        }
