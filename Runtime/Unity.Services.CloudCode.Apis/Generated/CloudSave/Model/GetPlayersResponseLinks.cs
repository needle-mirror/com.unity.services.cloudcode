...
{
    /// <summary>
    /// GetPlayersResponseLinks
    /// </summary>
    [DataContract(Name = "GetPlayersResponse_links")]
    public partial class GetPlayersResponseLinks : IEquatable<GetPlayersResponseLinks>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponseLinks" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPlayersResponseLinks() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponseLinks" /> class.
        /// </summary>
        /// <param name="next">The URL to the next page of results (required).</param>
        public GetPlayersResponseLinks(string next = default)
        {
            // to ensure "next" is required (not null)
            if (next == null)
            {
                throw new ArgumentNullException("next is a required property for GetPlayersResponseLinks and cannot be null");
            }
            this.Next = next;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPlayersResponseLinks {\n");
        ...
        {
            return this.Equals(input as GetPlayersResponseLinks);
        }

        /// <summary>
        /// Returns true if GetPlayersResponseLinks instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPlayersResponseLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPlayersResponseLinks input)
        {
            if (input == null)
            {
                return false;
