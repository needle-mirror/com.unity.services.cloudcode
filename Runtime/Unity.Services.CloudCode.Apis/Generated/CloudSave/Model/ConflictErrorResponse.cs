...
namespace Unity.Services.CloudSave.Model
{
    ...
    public partial class ConflictErrorResponse : IEquatable<ConflictErrorResponse>
    {
        /// <summary>
        ...
        public ConflictErrorResponse(string type = default, string title = default, int status = default, int code = default, string detail = default, string instance = default, ConflictErrorResponseData data = default)
        {
        ...
        {
            return this.Equals(input as ConflictErrorResponse);
        }

        /// <summary>
        /// Returns true if ConflictErrorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ConflictErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConflictErrorResponse input)
        {
            if (input == null)
            {
                return false;
