...
namespace Unity.Services.CloudSave.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPlayersResponse")]
    public partial class GetPlayersResponse : IEquatable<GetPlayersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPlayersResponse() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponse" /> class.
        /// </summary>
        /// <param name="results">results (required).</param>
        /// <param name="links">links (required).</param>
        public GetPlayersResponse(List<GetPlayersResponseResultsInner> results = default, GetPlayersResponseLinks links = default)
        {
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for GetPlayersResponse and cannot be null");
            }
            this.Results = results;
            // to ensure "links" is required (not null)
            if (links == null)
            {
                throw new ArgumentNullException("links is a required property for GetPlayersResponse and cannot be null");
            }
            this.Links = links;
        }
        ...
        public List<GetPlayersResponseResultsInner> Results { get; set; }

        /// <summary>
        /// Gets or Sets Links
        /// </summary>
        [DataMember(Name = "links", IsRequired = true, EmitDefaultValue = true)]
        public GetPlayersResponseLinks Links { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPlayersResponse {\n");
        ...
        {
            return this.Equals(input as GetPlayersResponse);
        }

        /// <summary>
        /// Returns true if GetPlayersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPlayersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPlayersResponse input)
        {
            if (input == null)
            {
                return false;
