...
{
    /// <summary>
    /// GetPlayersResponseResultsInner
    /// </summary>
    [DataContract(Name = "GetPlayersResponse_results_inner")]
    public partial class GetPlayersResponseResultsInner : IEquatable<GetPlayersResponseResultsInner>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponseResultsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPlayersResponseResultsInner() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPlayersResponseResultsInner" /> class.
        /// </summary>
        ...
        public GetPlayersResponseResultsInner(string id = default, AccessClassesWithMetadata accessClasses = default)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GetPlayersResponseResultsInner and cannot be null");
            }
            this.Id = id;
            // to ensure "accessClasses" is required (not null)
            if (accessClasses == null)
            {
                throw new ArgumentNullException("accessClasses is a required property for GetPlayersResponseResultsInner and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPlayersResponseResultsInner {\n");
        ...
        {
            return this.Equals(input as GetPlayersResponseResultsInner);
        }

        /// <summary>
        /// Returns true if GetPlayersResponseResultsInner instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPlayersResponseResultsInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPlayersResponseResultsInner input)
        {
            if (input == null)
            {
                return false;
