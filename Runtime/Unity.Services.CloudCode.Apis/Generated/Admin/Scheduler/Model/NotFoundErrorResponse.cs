...
namespace Unity.Services.Scheduler.Admin.Model
{
    ...
    public partial class NotFoundErrorResponse
    {
        ...
        protected NotFoundErrorResponse() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="NotFoundErrorResponse" /> class.
        /// </summary>
        ...
        public NotFoundErrorResponse(string type = default, string title = default, int status = default, int code = default, string detail = default, string instance = default)
        {
