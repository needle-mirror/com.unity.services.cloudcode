...
namespace Unity.Services.Scheduler.Admin.Model
{
    ...
    public partial class InternalServerErrorResponse
    {
        ...
        public InternalServerErrorResponse(string type = default, string title = default, int status = default, int code = default, string detail = default, string instance = default)
        {
