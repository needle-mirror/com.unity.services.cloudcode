...
namespace Unity.Services.Matchmaker.Model
{
    ...
    public partial class CustomAssignment : IEquatable<CustomAssignment>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAssignment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomAssignment() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAssignment" /> class.
        /// </summary>
        ...
        public CustomAssignment(string assignmentType = default, string message = default, StatusEnum? status = default, string matchId = default, Dictionary<string, Object> customData = default)
        {
            // to ensure "assignmentType" is required (not null)
            if (assignmentType == null)
            {
                throw new ArgumentNullException("assignmentType is a required property for CustomAssignment and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Custom data containing all connection information. This is the primary connection mechanism for custom assignments.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomAssignment {\n");
        ...
        {
            return this.Equals(input as CustomAssignment);
        }

        /// <summary>
        /// Returns true if CustomAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomAssignment input)
        {
            if (input == null)
            {
                return false;
