...
namespace Unity.Services.SecretManager.Model
{
    ...
    public partial class ForbiddenErrorResponse
    {
        ...
        public ForbiddenErrorResponse(string type = default, string title = default, int status = default, int code = default, string detail = default, string instance = default)
        {
