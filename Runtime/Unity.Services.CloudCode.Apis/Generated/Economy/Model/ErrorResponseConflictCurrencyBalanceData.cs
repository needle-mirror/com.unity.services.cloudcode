...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class ErrorResponseConflictCurrencyBalanceData : IEquatable<ErrorResponseConflictCurrencyBalanceData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseConflictCurrencyBalanceData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErrorResponseConflictCurrencyBalanceData() {}
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseConflictCurrencyBalanceData" /> class.
        /// </summary>
        /// <param name="attempted">attempted (required).</param>
        /// <param name="existing">existing (required).</param>
        public ErrorResponseConflictCurrencyBalanceData(CurrencyBalanceRequest attempted = default, CurrencyBalanceResponse existing = default)
        {
            ...
            if (existing == null)
            {
                throw new ArgumentNullException("existing is a required property for ErrorResponseConflictCurrencyBalanceData and cannot be null");
            }
        ...
        public CurrencyBalanceResponse Existing { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorResponseConflictCurrencyBalanceData {\n");
        ...
        {
            return this.Equals(input as ErrorResponseConflictCurrencyBalanceData);
        }

        /// <summary>
        /// Returns true if ErrorResponseConflictCurrencyBalanceData instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponseConflictCurrencyBalanceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponseConflictCurrencyBalanceData input)
        {
            if (input == null)
            {
                return false;
