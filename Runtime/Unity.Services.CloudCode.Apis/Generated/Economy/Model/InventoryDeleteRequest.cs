...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class InventoryDeleteRequest : IEquatable<InventoryDeleteRequest>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InventoryDeleteRequest {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InventoryDeleteRequest);
        }

        /// <summary>
        /// Returns true if InventoryDeleteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InventoryDeleteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InventoryDeleteRequest input)
        {
            if (input == null)
            {
                return false;
