...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class RealMoneyPurchaseResourceStoreIdentifiers : IEquatable<RealMoneyPurchaseResourceStoreIdentifiers>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RealMoneyPurchaseResourceStoreIdentifiers {\n");
            sb.Append("  AppleAppStore: ").Append(AppleAppStore).Append("\n");
            sb.Append("  GooglePlayStore: ").Append(GooglePlayStore).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RealMoneyPurchaseResourceStoreIdentifiers);
        }

        /// <summary>
        /// Returns true if RealMoneyPurchaseResourceStoreIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of RealMoneyPurchaseResourceStoreIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealMoneyPurchaseResourceStoreIdentifiers input)
        {
            if (input == null)
            {
                return false;
            ...
            return true &&
                (
                    this.AppleAppStore == input.AppleAppStore ||
                    (this.AppleAppStore != null &&
                        this.AppleAppStore.Equals(input.AppleAppStore))
                ) &&
                (
                    this.GooglePlayStore == input.GooglePlayStore ||
                    (this.GooglePlayStore != null &&
                        this.GooglePlayStore.Equals(input.GooglePlayStore))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.AppleAppStore.GetHashCode();
                }
                if (this.GooglePlayStore != null)
                {
                    hashCode = (hashCode * 59) + this.GooglePlayStore.GetHashCode();
                }
                return hashCode;
            }
        }
