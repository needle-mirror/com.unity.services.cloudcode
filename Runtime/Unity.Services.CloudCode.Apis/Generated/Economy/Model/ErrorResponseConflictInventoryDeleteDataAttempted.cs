...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class ErrorResponseConflictInventoryDeleteDataAttempted : IEquatable<ErrorResponseConflictInventoryDeleteDataAttempted>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorResponseConflictInventoryDeleteDataAttempted {\n");
        ...
        {
            return this.Equals(input as ErrorResponseConflictInventoryDeleteDataAttempted);
        }

        /// <summary>
        /// Returns true if ErrorResponseConflictInventoryDeleteDataAttempted instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponseConflictInventoryDeleteDataAttempted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponseConflictInventoryDeleteDataAttempted input)
        {
            if (input == null)
            {
                return false;
