...
{
    /// <summary>
    /// RunModule400OneOf model
    /// </summary>
    [Preserve]
    [JsonConverter(typeof(RunModule400OneOfJsonConverter))]
    [DataContract(Name = "RunModule400OneOf")]
    internal class RunModule400OneOf : IOneOf
    {
        ...
        /// <summary>RunModule400OneOf Constructor</summary>
        /// <param name="value">The value as an object for RunModule400OneOf</param>
        /// <param name="type">The type for RunModule400OneOf</param>
        public RunModule400OneOf(object value, Type type)
        {
            this.Value = value;
            this.Type = type;
        }
        ...
        /// <summary>
        /// Converts the JSON string into an instance of RunModule400OneOf
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of RunModule400OneOf</returns>
        public static RunModule400OneOf FromJson(string jsonString)
        {
            if (jsonString == null)
            {
                return null;
            ...
            else
            {
                ...
                {
                    throw new MissingFieldException("RunModule400OneOf", DiscriminatorKey);
                }
        ...
        private static RunModule400OneOf DeserializeIntoActualObject(string discriminatorValue, string jsonString)
        {
            ...
            return new RunModule400OneOf(actualObject, concreteType);
        }

        private static RunModule400OneOf DeserializeIntoActualObject(string jsonString)
        {
            ...
            return new RunModule400OneOf(results.First().ActualObject, results.First().ActualType);
        }
    }

    /// <summary>
    /// Custom JSON converter for RunModule400OneOf to allow for deserialization into OneOf type
    /// </summary>
    [Preserve]
    internal class RunModule400OneOfJsonConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return RunModule400OneOf.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
