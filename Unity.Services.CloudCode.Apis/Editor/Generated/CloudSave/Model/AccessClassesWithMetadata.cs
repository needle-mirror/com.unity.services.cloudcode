...
namespace Unity.Services.CloudSave.Model
{
    ...
    public partial class AccessClassesWithMetadata : IEquatable<AccessClassesWithMetadata>
    {
        /// <summary>
        ...
        public AccessClassesWithMetadata(AccessClassMetadata varDefault = default, AccessClassMetadata varPublic = default, AccessClassMetadata varProtected = default, AccessClassMetadata varPrivate = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessClassesWithMetadata {\n");
        ...
        {
            return this.Equals(input as AccessClassesWithMetadata);
        }

        /// <summary>
        /// Returns true if AccessClassesWithMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessClassesWithMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessClassesWithMetadata input)
        {
            if (input == null)
            {
                return false;
