...
namespace Unity.Services.CloudSave.Model
{
    ...
    public partial class AccessClassMetadata : IEquatable<AccessClassMetadata>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessClassMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccessClassMetadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccessClassMetadata" /> class.
        /// </summary>
        ...
        public AccessClassMetadata(int totalSize = default, int numKeys = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccessClassMetadata {\n");
        ...
        {
            return this.Equals(input as AccessClassMetadata);
        }

        /// <summary>
        /// Returns true if AccessClassMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AccessClassMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccessClassMetadata input)
        {
            if (input == null)
            {
                return false;
