...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class ErrorResponseConflictInventoryUpdateData : IEquatable<ErrorResponseConflictInventoryUpdateData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseConflictInventoryUpdateData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErrorResponseConflictInventoryUpdateData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponseConflictInventoryUpdateData" /> class.
        /// </summary>
        /// <param name="attempted">attempted (required).</param>
        /// <param name="existing">existing (required).</param>
        public ErrorResponseConflictInventoryUpdateData(AddInventoryRequest attempted = default, InventoryResponse existing = default)
        {
            ...
            if (existing == null)
            {
                throw new ArgumentNullException("existing is a required property for ErrorResponseConflictInventoryUpdateData and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorResponseConflictInventoryUpdateData {\n");
        ...
        {
            return this.Equals(input as ErrorResponseConflictInventoryUpdateData);
        }

        /// <summary>
        /// Returns true if ErrorResponseConflictInventoryUpdateData instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponseConflictInventoryUpdateData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponseConflictInventoryUpdateData input)
        {
            if (input == null)
            {
                return false;
