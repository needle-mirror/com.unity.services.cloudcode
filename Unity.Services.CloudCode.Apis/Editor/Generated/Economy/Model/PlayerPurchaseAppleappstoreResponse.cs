...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class PlayerPurchaseAppleappstoreResponse : IEquatable<PlayerPurchaseAppleappstoreResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerPurchaseAppleappstoreResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayerPurchaseAppleappstoreResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerPurchaseAppleappstoreResponse" /> class.
        /// </summary>
        /// <param name="verification">verification (required).</param>
        /// <param name="rewards">rewards (required).</param>
        public PlayerPurchaseAppleappstoreResponse(PlayerPurchaseAppleappstoreResponseVerification verification = default, PlayerPurchaseVirtualResponseRewards rewards = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerPurchaseAppleappstoreResponse {\n");
        ...
        {
            return this.Equals(input as PlayerPurchaseAppleappstoreResponse);
        }

        /// <summary>
        /// Returns true if PlayerPurchaseAppleappstoreResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayerPurchaseAppleappstoreResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerPurchaseAppleappstoreResponse input)
        {
            if (input == null)
            {
                return false;
