...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class PlayerInventoryResponse : IEquatable<PlayerInventoryResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerInventoryResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayerInventoryResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerInventoryResponse" /> class.
        /// </summary>
        /// <param name="results">List of player&#39;s inventory items. (required).</param>
        /// <param name="links">links (required).</param>
        public PlayerInventoryResponse(List<InventoryResponse> results = default, PlayerCurrencyBalanceResponseLinks links = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerInventoryResponse {\n");
        ...
        {
            return this.Equals(input as PlayerInventoryResponse);
        }

        /// <summary>
        /// Returns true if PlayerInventoryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayerInventoryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerInventoryResponse input)
        {
            if (input == null)
            {
                return false;
