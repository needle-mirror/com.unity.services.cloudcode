...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class PlayerCurrencyBalanceResponse : IEquatable<PlayerCurrencyBalanceResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerCurrencyBalanceResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PlayerCurrencyBalanceResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerCurrencyBalanceResponse" /> class.
        /// </summary>
        /// <param name="results">List of currency balances. (required).</param>
        /// <param name="links">links (required).</param>
        public PlayerCurrencyBalanceResponse(List<CurrencyBalanceResponse> results = default, PlayerCurrencyBalanceResponseLinks links = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerCurrencyBalanceResponse {\n");
        ...
        {
            return this.Equals(input as PlayerCurrencyBalanceResponse);
        }

        /// <summary>
        /// Returns true if PlayerCurrencyBalanceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PlayerCurrencyBalanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlayerCurrencyBalanceResponse input)
        {
            if (input == null)
            {
                return false;
