...
namespace Unity.Services.Economy.Model
{
    ...
    public partial class CurrencyResource : IEquatable<CurrencyResource>
    {
        ...
        public CurrencyResource(string id = default, string name = default, TypeEnum type = default, ModifiedMetadata created = default, ModifiedMetadata modified = default, int initial = default, int max = default, Object customData = default)
        {
