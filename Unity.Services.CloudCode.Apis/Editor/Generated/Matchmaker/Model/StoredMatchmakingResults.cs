...
namespace Unity.Services.Matchmaker.Model
{
    ...
    public partial class StoredMatchmakingResults : IEquatable<StoredMatchmakingResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredMatchmakingResults" /> class.
        /// </summary>
        ...
        public StoredMatchProperties MatchProperties { get; set; }
        ...
        /// </summary>
        /// <value>Matchmaking queue that created the match.</value>
        ...
        /// </summary>
        /// <value>Matchmaking pool that created the match.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredMatchmakingResults {\n");
        ...
        {
            return this.Equals(input as StoredMatchmakingResults);
        }

        /// <summary>
        /// Returns true if StoredMatchmakingResults instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredMatchmakingResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredMatchmakingResults input)
        {
            if (input == null)
            {
                return false;
